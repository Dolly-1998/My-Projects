...
class MobileApp extends Component{
    state = {
       mobiles: [{name: "Mi A1",brand: "Xiaomi",RAM: "4GB",ROM: "64GB",price:9999},
    ...
    const brands=mobiles.reduce((acc,curr)=>acc.includes(curr.brand)?acc:[...acc,curr.brand],[])
    console.log(brands);
    return(
...
<Switch>
    <Route path="/mobiles" render={(props)=><Mobiles {...props} mobiles={mobiles}/>}/>
     <Route path="/:brand" render={(props)=><Mobiles {...props} mobiles={mobiles}/>}/>
